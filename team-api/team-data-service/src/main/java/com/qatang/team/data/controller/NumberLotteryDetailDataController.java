...
public class NumberLotteryDetailDataController extends BaseController {
    @Autowired
    private NumberLotteryDataInternalService numberLotteryDataInternalService;

    @RequestMapping(value = "/batchCreate", method = RequestMethod.POST)
    NumberLotteryData batchCreate(@RequestBody List<NumberLotteryDetailData> numberLotteryData) {
