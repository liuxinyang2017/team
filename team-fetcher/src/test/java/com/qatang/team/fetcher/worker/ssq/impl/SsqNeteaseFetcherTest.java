 ...
 * @author qatang
 */
public class SsqNeteaseFetcherTest {

    @Test
    public void testFetchResult() {
        INumberLotteryFetcher numberLotteryFetcher = new SsqNeteaseFetcher();
        NumberLotteryFetchResult numberLotteryFetchResult = numberLotteryFetcher.fetchResult("2017091");
        Assert.assertTrue(numberLotteryFetchResult.getResult() != null);
        System.out.println(numberLotteryFetchResult.getResult());

        numberLotteryFetchResult = numberLotteryFetcher.fetchDetail("2017091");
        Assert.assertTrue(numberLotteryFetchResult.getResult() != null);
        System.out.println(numberLotteryFetchResult.getResult());
