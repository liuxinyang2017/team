 ...
 * @author qatang
 */
public class BaiduProxyValidator extends AbstractProxyValidator {
    private final static ProxyValidatorType PROXY_VALIDATOR_TYPE = ProxyValidatorType.V_BAIDU;
